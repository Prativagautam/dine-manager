...
const TableFormSchema = z.object({
	...
	grid_x: z.number().min(0, 'Grid X must be 0 or greater').max(11, 'Grid X cannot exceed 11'),
	grid_y: z.number().min(0, 'Grid Y must be 0 or greater').max(11, 'Grid Y cannot exceed 11'),
});
...
const TableForm = ({ opened, mode, defaultValues, loading, error, onClose, onSubmit }: TableFormProps) => {
	const {
		control,
		handleSubmit,
		reset,

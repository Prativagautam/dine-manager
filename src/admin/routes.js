...
import FloorPlan from "./pages/floor-plan/index.tsx";
    ...
    <>
      <Flex>
        ...
        <Box style={{ flex: 1, minWidth: 0 }}>
          ...
          <AtrcMain>
            <AtrcRoutes>
              <AtrcRoute index element={<Dashboard />} />
              <AtrcRoute exact path="/settings/*" element={<InitSettings />} />
              <AtrcRoute
                exact
                path="/menu"
                element={
  ...
  return (
    <AtrcReduxContextData.Provider value={{ ...dbProps }}>
      <AtrcHashRouter basename="/">
        <AtrcWrap variant="wrp" className="at-box-szg at-m at-typ">
          <AdminRoutes />
        </AtrcWrap>
      </AtrcHashRouter>
...
document.addEventListener("DOMContentLoaded", () => {
  const rootElement = document.getElementById(
    RestaurantManagementSystemLocalize.root_id,
  );
